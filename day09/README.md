Cli-агент для получения реквизитов компании в виде JSON или обычного текста (имеет память диалога через JSON-файл и выводит количество использованных токенов).
